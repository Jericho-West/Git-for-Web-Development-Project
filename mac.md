...
Git is a system used for coding-related purposed; GitHub is a service used for sharing code to the cloud

2. Why do we create a branch? 
To edit code without editing the origional

3. What is the purpose of a pull request? 
It informs people about changes you've made to a repository

4. What is the command you can use to switch between branches? For example you are working on a feature branch and you want to switch back to main. 
git checkout

5. Explain the difference between `git fetch`, `git merge` and `git pull` what does each command do? 
fetch allows you to see what people are working on by refferencing files
push uploads local work to the remote repository
pull dowloads content from the remote repository to the local one

6. What is a merge conflict? How do you resolve a merge conflict? 
When there are 2 different changes to the same item; 